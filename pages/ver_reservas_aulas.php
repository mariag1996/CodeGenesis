    ...
    <table class="tabla_lista tabla" border="1" cellpadding="6" cellspacing="0">
        ...
        <tbody>
            ...
            <tr class="tabla-fila">
                ...
                <td class="tabla-celda"><?= htmlspecialchars($r['creado_en']) ?></td>  <td class="tabla-celda"><?= htmlspecialchars($r['estado']) ?></td>
                <td class="tabla-celda">
                    <?php if ($r['estado'] === 'vigente'): ?>
    <form method="POST" action="actualizar_estado_reserva_aula.php" style="display:inline;">
