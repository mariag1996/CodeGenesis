<!-- ......Este archivo se encarga de cambiar la contraseña del usuario docente........ -->
<?php
// =====================================
...
$usuario = $_SESSION['usuario']; // Cédula del docente (entero)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // =====================================
        ...
        $stmt = $db->prepare("UPDATE docente SET contraseña = ? WHERE usuario = ?");
